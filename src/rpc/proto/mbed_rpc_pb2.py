...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_HEADER'].fields_by_name['seqId']._serialized_options = b'\222?\0028\020'
  ...
  _globals['_HEADER_CONSTANTS']._serialized_start=133
  _globals['_HEADER_CONSTANTS']._serialized_end=159
