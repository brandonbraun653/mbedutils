...
extern "C" int fal_flash_init( void )
{
  // size_t i;
 ...
 */
extern "C" void fal_show_part_table(void)
{
 ...
 */
extern "C" int fal_partition_init(void)
{
...
extern "C" static const struct fal_flash_dev *flash_device_find_by_part(const struct fal_partition *part)
{
 ...
 */
extern "C" const struct fal_partition *fal_get_partition_table(size_t *len)
{
    assert(init_ok);
    assert(len);
 ...
 */
extern "C" void fal_set_partition_table_temp(struct fal_partition *table, size_t len)
{
    assert(init_ok);
    assert(table);
 ...
 *           -1: error
 */
extern "C" int fal_partition_erase_all(const struct fal_partition *part)
{
